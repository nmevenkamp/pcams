...
template <class RealType>  class Parallelogram {
public:
  aol::Vec2<RealType> _origin, _v1, _v2;
  
  Parallelogram ( const aol::Vec2<RealType> &origin, const aol::Vec2<RealType> &v1, const aol::Vec2<RealType> &v2 )
    : _origin ( origin ), _v1 ( v1 ), _v2 ( v2 ) { }
  
  bool contains ( const aol::Vec2<RealType> &p ) {
    const RealType d = _v1[0] * _v2[1] - _v1[1] * _v2[0];
    aol::Vec2<RealType> pp ( _origin );
    pp -= p;
