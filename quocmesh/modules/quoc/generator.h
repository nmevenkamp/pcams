...
public:
  ...
  void generateEllipse ( aol::Vector<RealType> &Image, const RealType Intensity = 1., const RealType a = 0.3, const RealType b = 0.5, const RealType CenterX = 0.5, const RealType CenterY = 0.5 ) {
