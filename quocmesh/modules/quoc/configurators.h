...
public:
  ...
  inline int localOnFaceToLocal ( const qc::Element &/*El*/, const int localIndex ) const {
    static bool localOnFaceToLocalWarningPrinted = false;
    if ( !localOnFaceToLocalWarningPrinted ) {
      cerr << aol::color::error << "qc::RectangularGridConfiguratorBase::localOnFaceToLocal has not been tested yet! Please don't remove this warning before testing it properly!" << aol::color::reset << endl;;
      localOnFaceToLocalWarningPrinted = true;
    }
